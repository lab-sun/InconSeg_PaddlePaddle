...
parser.add_argument('--weight_name', '-w', type=str, default='PaddleInconSe_RGB_Disparity') 
...
if __name__ == '__main__':
    ...
    batch_size = 1
    test_dataset  = PD_RGB_Disparity_dataset(data_dir=args.data_dir, split=args.dataset_split, input_h=args.img_height, input_w=args.img_width)
